...
export default function Contact() {
  ...
  return (
    ...
    >
      ...
      <p className="text-gray-700 -mt-6 dark:text-white/80">Contact me directly at{" "}<a className='underline' href='mailto:mrityunjay.singh119@gmail.com'>mrityunjay.singh119@gmail.com</a>{" "}or through this form.</p>
